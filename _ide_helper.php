 ...
 * Generated for Laravel 7.12.0 on 2020-05-20 10:16:56.
 *
...
namespace App\Slate\Facades {
    ...
    class Slate
    {
         ...
         * @static
         */
        public static function serialize($nodeList)
        {
            /** @var \App\Slate\Slate $instance */
            return $instance->serialize($nodeList);
        }
         ...
         * @static
         */
        public static function renderListItem($node)
        {
            /** @var \App\Slate\Slate $instance */
            return $instance->renderListItem($node);
        }
         ...
         * @static
         */
        public static function renderBlock($node)
        {
            /** @var \App\Slate\Slate $instance */
            return $instance->renderBlock($node);
        }
    }
...
namespace  {
    ...
    class Slate extends \App\Slate\Facades\Slate
    {
    }
